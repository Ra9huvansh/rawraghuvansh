...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Raghuvansh Rastogi',", type: 'array-item' },
    { code: "    role: 'Web3 Full Stack Developer',", type: 'array-item' },
    { code: "    bio: 'Forging the future on-chain'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Raghuvansh <span className={styles.accentText}>Rastogi</span>
          </h1>

          <div className={styles.developerRole}>Java Backend & Smart Contract Developer</div>

          <p className={styles.bio}>
          I build secure, scalable decentralized applications integrating smart contracts and modern web technologies. Focused on clean architecture, robust backend, and on-chain innovation.
          </p>
